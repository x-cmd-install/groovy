...
合计: **688,954** 行代码（覆盖前 5 种语言、共 **5081** 个文件）。
...
- **发布数**: 0 · **已合并 PR**: 1645 · **开放 PR**: 15 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 23596
...
在 [repology.org](https://repology.org/project/groovy) 上共有 **119** 个发行版报告此项目。**14** 个 ✅ 已是最新上游版本，**79** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T06:10:32Z._
